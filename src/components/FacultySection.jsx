                            ...
                            {visibleItems.map((item, i) => (
                                <div key={i} className="group cursor-pointer">
                                    ...
                                    <div className="relative bg-gray-50 rounded-2xl overflow-hidden aspect-square flex items-center justify-center border border-gray-100">
                                        ...
                                        {/* Wishlist */}
                                        <button className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white shadow flex items-center justify-center text-gray-400 hover:text-pink-500 transition-colors duration-200">
